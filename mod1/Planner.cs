namespace JunimoIntelliBox
{
    ...
    public class Planner
    {
        ...
        public IEnumerable<IPlan> CreateAnimalProductCollectionPlan(JunimosManager junimosManager)
        {
            ...
            foreach (Building building in animalBuildings)
            {
                ...
                foreach (KeyValuePair<Vector2, StardewValley.Object> keyValuePair in products)
                {
                    ...
                    plans.Add(new AnimalProductCollectionPlan(keyValuePair.Key, product, building, chests, junimosManager));
